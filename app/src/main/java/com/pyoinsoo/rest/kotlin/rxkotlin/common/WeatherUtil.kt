package com.pyoinsoo.rest.kotlin.rxkotlin.common
...
class WeatherUtil {
    ...
    companion object {
         ...
         * 날짜 형식을 지정
         */
        private val  yyyyMMddFormet =
                SimpleDateFormat(MyApplication.myApplication.getString(R.string.yyyyMMmmFormat))
